...
export default class Biscuit extends Component {
    ...
    handaleColorChange = () => {
        let top = document.querySelector(`#BiscuitIcon${this.props.id} #Top`);
        let front = document.querySelector(`#BiscuitIcon${this.props.id} #Front`);
        let line = document.querySelector(`#BiscuitIcon${this.props.id} #Line`);
